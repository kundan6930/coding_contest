...
//ll const n1=1e5+1;
//ll dp[n1][3][3][3];
ll solve1(string &s ,ll pos,ll prev,ll prev1,ll prev2,vector<vector<vector<vector<ll>>>>&dp)
{
   if(pos==n)
   {
   // cout<<prev<<" "<<prev1<<" "<<endl;
     if(prev==1 && ( (prev1==2) || (prev1==1)))
    {
        return 0;
    }
    else if(prev2==0 && prev1==1 && prev==0)
    {
         return 0;
    }
    else if(prev==2 )
   ...
   if(dp[pos][prev][prev1][prev2]!=-1)
   {
      return dp[pos][prev][prev1][prev2];
   }
   ll c=0;
   //ll p1=prev;
 //  cout<<prev<<" "<<(s[pos]-'a')<<" "<<prev1<<endl;

   if(((prev==1 ||prev==2) && ((s[pos]-'a')==1)) || (prev2==0 && prev1==1 && prev==0 && ((s[pos]-'a')==0) ))
   { 
    
     c+= solve1(s,pos+1,prev,prev1,prev2,dp);
   ...
   else
   {
            ...
            c+=solve1(s,pos+1,s[pos]-'a',prev,prev1,dp);
            c%=Mod;
             c+= solve1(s,pos+1,prev,prev1,prev2,dp);
             c%=Mod;
   }
  ...
  return dp[pos][prev][prev1][prev2]=c;
}
void solve() {
   int t;
   cin>>t;
...
vector<vector<vector<vector<ll>>>>dp(n+1,vector<vector<vector<ll>>>(3,vector<vector<ll>>(3,vector<ll>(3,-1))));
 cout<<solve1(s,0,2,2,2,dp)<<endl;
   }
}
